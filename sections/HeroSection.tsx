...
import prometheus from "../public/prometheus-illustration.webp";
...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        PASSIONATE PROGRAMMER FULL-STACK ENGINEER
      </span>
        ...
        <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-90 xs:scale-95 mx-auto">
            <Image
              ...
              aria-label="Kenji Anderson character illustration levitating with a Macbook"
              alt="Kenji Anderson character illustration"
            />
          </div>
